...
interface SimpleCoverageStatsProps {
  sites: LTESite[];
...
export const SimpleCoverageStats: React.FC<SimpleCoverageStatsProps> = ({
  sites,
  parameters,
                ...
                {frequencyData.map((item, index) => (
                  <div key={item.frequency} className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2 flex-1 ml-4">
                      ...
                      <span className="text-sm text-muted-foreground w-12">{item.sites} sites</span>
                    </div>
                  </div>
                ))}
              </div>
                  ...
                  return (
                    <div key={item.name} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-muted-foreground w-12">{item.value} sites</span>
                      </div>
                    </div>
                  );
                })}
